...
const POST = async ({
  ...
  try {
    ...
    const apiKey = "AIzaSyBw7TayuVgl37iA3jOLLDJOuLttZncbMvo";
    if (!apiKey) ;
...
- Deep cut analysis should feel like it was written by a music journalist`;
    ...
    const textPart = result.candidates?.[0]?.content?.parts?.find((p) => p.text !== void 0);
    ...
    return new Response(JSON.stringify({
      error: "Failed to generate music report"
    }), {
      status: 500,
      headers: {
        "Content-Type": "application/json"
